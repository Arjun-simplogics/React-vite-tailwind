...
export const createLocation = (path: string, replacements: { [name: string]: string }): string => {
...
export const showError = (msg: string): void => {
	message.error(i18Get(msg, Config.defaultLanguage));
};

export const showInfo = (msg: string): void => {
	message.info(i18Get(msg, Config.defaultLanguage));
};

export const showSuccess = (msg: string): void => {
	message.success(i18Get(msg, Config.defaultLanguage));
};

export const showWarning = (msg: string): void => {
	message.warning(i18Get(msg, Config.defaultLanguage));
};

export const showDelayError = (msg: string): void => {
	message.error({ content: i18Get(msg, Config.defaultLanguage), duration: 15 });
};

export const showDelayWarning = (msg: string): void => {
	message.warning({ content: i18Get(msg, Config.defaultLanguage), duration: 15 });
};

export const showDelayInfo = (msg: string): void => {
...
export const formatNumberWithSeparator = (number: number | null) => {
	if (number) {
...
export const generateFormattedName = (eventName: string | undefined) => {
	let newName: string | undefined = "";
	newName = eventName?.replace(/[,[\]?.<>:/;|*]/g, "-");
	return newName;
};
